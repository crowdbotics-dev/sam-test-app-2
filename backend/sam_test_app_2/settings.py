"""
Django settings for sam_test_app_2 project.
...
ROOT_URLCONF = 'sam_test_app_2.urls'
...
WSGI_APPLICATION = 'sam_test_app_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sam-test-app Support <support@sam-test-app-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_test_app_2 API",
    "DESCRIPTION": "API documentation for sam_test_app_2 App",
    "VERSION": "v1",
}
